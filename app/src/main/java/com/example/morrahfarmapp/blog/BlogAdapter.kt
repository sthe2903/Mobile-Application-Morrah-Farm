...
class BlogAdapter (private val empList: ArrayList<BlogModel>) :
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.tvEmpName.text = currentEmp.empJudul
    }
    ...
    class ViewHolder(itemView: View, clickListener: onItemClickListener) : RecyclerView.ViewHolder(itemView) {
        ...
        val tvEmpName : TextView = itemView.findViewById(R.id.tvEmpJudul)
